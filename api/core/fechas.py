...
def primera_fecha_cuota_programada(
    ...
    """Primera cuota según día de cobro (cartera/cliente).

    - Entrega el día anterior al cobro (p. ej. domingo antes de lunes): cobro en el día inmediato.
    - Entrega en el día de cobro o después: cobro en el día de la semana siguiente.
    """
...
def calculate_fecha_cuota(
    ...
    """Calcula la fecha programada de cuota según periodicidad y día de cobro."""
